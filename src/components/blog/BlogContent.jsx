...
export default function BlogContent() {
  return (
    ...
    <div className="container mx-auto px-5 lg:px-0 banner-content">
        <div className="my-10 ">
            ...
            <p className="py-4">I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil
                existence, that I
        ...
        <div className="flex justify-center">
            <figure>
                <p title="Skin Care Product" className="image-link"><img src="images/blogpage-img2.png" className="img-fluid" alt="" /></p>
                <figcaption className="text-center">Skin care lotion for your daily routine</figcaption>
            </figure>
        </div>
        ...
        <div className="my-10 ">
            ...
            <p className="py-4"> <b> When, while the lovely valley teems with vapour around me, and the meridian sun
